           ...
           <template v-slot:icon>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Laporan Form B OPD Rencana Kegiatan dan Anggaran (RKA) OPD APBD Murni  s.d <strong>BULAN {{$store.getters['uifront/getNamaBulan']}} T.A {{$store.getters['uifront/getTahunAnggaran']}}</strong>
                </v-alert>
            </template>
        </ModuleHeader>
        <v-container fluid>    
...
export default {
    ...
    {
        this.fetchOPD(); 
        var OrgID_Selected=this.$store.getters['uiadmin/AtributeValueOfPage']('formbopdmurni','OrgID_Selected');           
    ...
    methods :{
        ...
        loaddatakegiatan:async function ()
        {
            ...
            await this.$ajax.post('/report/formbopdmurni',
                {
                    tahun:this.$store.getters['uifront/getTahunAnggaran'],                       
        ...
        printtoexcel:async function ()
        {
            ...
            await this.$ajax.post('/report/formbopdmurni/printtoexcel',
                {
                    tahun:this.$store.getters['uifront/getTahunAnggaran'],                       
                    no_bulan:this.$store.getters['uifront/getBulanRealisasi'],                       
                    OrgID:this.OrgID_Selected,                       
