           ...
           <template v-slot:icon>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Laporan Form B OPD Rencana Kegiatan dan Anggaran (RKA) OPD APBD Perubahan s.d <strong>BULAN {{$store.getters['uifront/getNamaBulan']}} T.A {{$store.getters['uifront/getTahunAnggaran']}}</strong>
                </v-alert>
            </template>
        </ModuleHeader>
        <v-container fluid>    
...
export default {
    ...
    {
        this.fetchOPD(); 
        var OrgID_Selected=this.$store.getters['uiadmin/AtributeValueOfPage']('formbopdperubahan','OrgID_Selected');           
