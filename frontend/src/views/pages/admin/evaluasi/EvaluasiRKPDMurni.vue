<template>
   <EvaluasiRKPDLayout :temporaryleftsidebar="true">
           ...
           <template v-slot:icon>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Laporan Evaluasi RKPD (Rencana Kerja Pemerintah Daerah) Murni
                </v-alert>
            </template>
        </ModuleHeader>
        <v-container fluid>    
...
export default {
    ...
    {
        this.fetchOPD(); 
        var OrgID_Selected=this.$store.getters['uiadmin/AtributeValueOfPage']('evaluasirkpdmurni','OrgID_Selected');          
    ...
    methods :{
        ...
        loaddatakegiatan:async function ()
        {
            ...
            await this.$ajax.post('/report/evaluasirkpdmurni',
                {
                    tahun:this.$store.getters['uifront/getTahunAnggaran'],                                           
        ...
        printtoexcel:async function ()
        {
            ...
            await this.$ajax.post('/report/evaluasirkpdmurni/printtoexcel',
                {
                    tahun:this.$store.getters['uifront/getTahunAnggaran'],                                           
                    OrgID:this.OrgID_Selected,                       
                },
                ...
                link.setAttribute('download', 'evaluasi_rkpd_murni_'+Date.now()+'.xlsx');
    ...
    watch:{
        OrgID_Selected (val)
        {   
            var page = this.$store.getters['uiadmin/Page']('evaluasirkpdmurni');
