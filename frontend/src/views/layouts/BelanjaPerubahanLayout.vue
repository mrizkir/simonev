<template>
    <div>
        ...
        <v-navigation-drawer v-model="drawer" width="300" dark :class="this.$store.getters['uifront/getTheme']('V-NAVIGATION-DRAWER-CSS-CLASS')" :temporary="temporaryleftsidebar" app>
			...
			<v-divider></v-divider>
            <v-list expand>
                <v-list-item :to="{path:'/belanjaperubahan'}" v-if="CAN_ACCESS('BELANJA-GROUP_BROWSE')" link class="yellow" color="green" >
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-home-floor-b</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>BOARD BELANJA PERUBAHAN</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>                
                <v-divider />
                ...
                <v-list-item link v-if="CAN_ACCESS('FORM A PERUBAHAN_BROWSE')" to="/belanjaperubahan/report/forma">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-graph</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                ...
                <v-list-item link v-if="CAN_ACCESS('FORM B PERUBAHAN_BROWSE')" to="/belanjaperubahan/report/formbopd">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-graph</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                ...
                <v-list-item link v-if="CAN_ACCESS('FORM B PERUBAHAN_BROWSE')" to="/belanjaperubahan/report/formbunitkerja">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-graph</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                ...
                <v-list-item to="/belanjaperubahan/statistik/peringkatopd" link>
                    <v-list-item-icon class="mr-2">
