<template>
    <div>
        ...
        <v-navigation-drawer v-model="drawer" width="300" dark :class="this.$store.getters['uifront/getTheme']('V-NAVIGATION-DRAWER-CSS-CLASS')" :temporary="temporaryleftsidebar" app>
			...
			<v-divider></v-divider>
            <v-list expand>
                <v-list-item :to="{path:'/evaluasirkpd'}" v-if="CAN_ACCESS('EVALUASI-RKPD_BROWSE')" link class="yellow" color="green" >
                    <v-list-item-icon class="mr-2">
                ...
                <v-list-item link v-if="CAN_ACCESS('EVALUASI RKPD MURNI_BROWSE')" to="/evaluasirkpd/murni">
                    <v-list-item-icon class="mr-2">
                ...
                <v-list-item link v-if="CAN_ACCESS('EVALUASI RKPD PERUBAHAN_BROWSE')" to="/evaluasirkpd/perubahan">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-graph</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
