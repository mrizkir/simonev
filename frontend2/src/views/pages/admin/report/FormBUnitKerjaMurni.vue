           ...
           <template v-slot:icon>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Laporan Form B Unit Kerja Rencana Kegiatan dan Anggaran (RKA) OPD APBD Murni   s.d <strong>BULAN {{$store.getters['uifront/getNamaBulan']}} T.A {{$store.getters['uifront/getTahunAnggaran']}}</strong>
                </v-alert>
            </template>
        </ModuleHeader>
        <v-container fluid>    
                        ...
                        <template v-slot:body="{ items }">
                            <tbody>
                                <tr v-for="(item) in items" v-bind:key="item.FormBMurniID" v-bind:class="{'indigo lighten-4 font-weight-bold':isProgram(item)}">
                                    ...
                                    <td class="text-right">{{item.bobot1|makeLookPrecision}}</td>                                    
                                    ...
                                    <td class="text-right">{{item.fisik_ttb1|makeLookPrecision}}</td>                                    
                                    <td class="text-right">{{item.keuangan_target1|formatUang}}</td>                                    
                                    <td class="text-right">{{item.keuangan_target_persen_1|makeLookPrecision}}</td>                                    
                                    ...
                                    <td class="text-right">{{item.keuangan_ttb1|makeLookPrecision}}</td>                                    
...
export default {
    ...
    {
        this.fetchOPD(); 
        var OrgID_Selected=this.$store.getters['uiadmin/AtributeValueOfPage']('formbunitkerjamurni','OrgID_Selected');  
        var SOrgID_Selected=this.$store.getters['uiadmin/AtributeValueOfPage']('formbunitkerjamurni','SOrgID_Selected');  
    ...
    data ()
    {
        return {
            ...
            headers: [                        
                ...
                { text: 'BOBOT (%)', value: 'bobot1',align:'end',width:100,sortable:false },   
                ...
                { text: 'TTB FISIK (%)', value: 'fisik_ttb1',align:'end',width:100,sortable:false},                   

                { text: 'TARGET KEUANGAN (RP)', value: 'keuangan_target1',align:'end',width:100,sortable:false },   
                { text: '(%)', value: 'keuangan_target_persen_1',align:'end',width:100,sortable:false },   
                ...
                { text: 'TTB KEUANGAN (%)', value: 'keuangan_ttb1',align:'end',width:100,sortable:false },   
