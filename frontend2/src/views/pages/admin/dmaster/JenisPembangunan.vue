                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar flat color="white">
                                <v-toolbar-title>DAFAR JENIS PEMBANGUNAN</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
                        ...
                        <template v-slot:expanded-item="{ headers, item }">
                            <td :colspan="headers.length" class="text-center">
                                <strong>ID:</strong>{{ item.JenisPembangunanID }}
    ...
    methods: {
        initialize:async function () 
        {
            ...
            await this.$ajax.post('/dmaster/jenispembangunan',
                ...
                this.datatable = data.jenispembangunan;
        ...
        save () {
            if (this.$refs.frmdata.validate())
            {
                ...
                {
                    this.$ajax.post('/dmaster/jenispembangunan/'+this.formdata.JenisPembangunanID,
                        {
                            '_method': 'PUT',
                        ...
                        Object.assign(this.datatable[this.editedIndex], data.jenispembangunan);
                        this.closedialogfrm();
                    }).catch(()=>{
                    ...
                    this.$ajax.post('/dmaster/jenispembangunan/store',
                        {
                            NamaJenis:this.formdata.NamaJenis,    
                            Descr:'',          
                        ...
                        this.datatable.push(data.jenispembangunan);
                        this.closedialogfrm();
                    }).catch(()=>{
                        this.btnLoading = false;
                    });
        ...
        deleteItem (item) {           
            this.$root.$confirm.open("Delete", 'Apakah Anda ingin menghapus data dengan ID '+item.JenisPembangunanID+' ?', { color: 'red' }).then((confirm) => {
                if (confirm)
                {
                    this.btnLoading = true;
                    this.$ajax.post('/dmaster/jenispembangunan/'+item.JenisPembangunanID,
                        {
                            _method: "DELETE",
                        },
                        {
