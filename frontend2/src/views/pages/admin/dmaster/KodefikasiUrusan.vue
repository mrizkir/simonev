                    ...
                    <v-data-table
                            ...
                            <v-toolbar flat color="white">
                                ...
                                <v-dialog v-model="dialogfrm" max-width="800px" persistent>
                                    <template v-slot:activator="{ on }">
                                        <v-btn color="primary" dark class="mb-2" v-on="on" :disabled="!$store.getters['auth/can']('URUSAN_STORE')">TAMBAH</v-btn>
                                    </template>
                        ...
                        <template v-slot:item.actions="{ item }">
                            ...
                            <v-icon
                                small
                                class="mr-2"
                                :disabled="!$store.getters['auth/can']('URUSAN_UPDATE')"
                            ...
                            <v-icon
                                small
                                :loading="btnLoading"
                                :disabled="btnLoading||!$store.getters['auth/can']('URUSAN_STORE')"
...
export default {
    ...
    data ()
    {
        return {
            ...
            datatable:[],
            headers: [                        
                { text: 'KODE URUSAN', value: 'Kd_Urusan',width:150 },   
                { text: 'NAMA URUSAN', value: 'Nm_Urusan' },   
            ...
            rule_kode:[
                ...
                value => /^[0-9]+$/.test(value) || 'Kode Urusan hanya boleh angka',                
            ], 
            rule_name:[
                value => !!value||"Mohon untuk di isi Nama Urusan !!!",                  
                value => /^[A-Za-z\s\\,\\.]*$/.test(value) || 'Nama Urusan hanya boleh string dan spasi',             
            ], 
        };
    },
    methods: {
        initialize:async function () 
        {
            ...
            await this.$ajax.post('/dmaster/kodefikasi/urusan',
                {
        ...
        save () {
            if (this.$refs.frmdata.validate())
            {
                ...
                {
                    this.$ajax.post('/dmaster/kodefikasi/urusan/'+this.formdata.KUrsID,
                        {
                            '_method':'PUT',
                    ...
                    this.$ajax.post('/dmaster/kodefikasi/urusan/store',
                        {
                            Kd_Urusan:this.formdata.Kd_Urusan,
                            Nm_Urusan:this.formdata.Nm_Urusan,
                            Descr:this.formdata.Descr,
        ...
        deleteItem (item) {           
            this.$root.$confirm.open('Delete', 'Apakah Anda ingin menghapus data urusan dengan ID '+item.KUrsID+' ?', { color: 'red' }).then((confirm) => {
                if (confirm)
                {
                    this.btnLoading=true;
                    this.$ajax.post('/dmaster/kodefikasi/urusan/'+item.KUrsID,
                        {
                            '_method':'DELETE',
                        },
                        {
