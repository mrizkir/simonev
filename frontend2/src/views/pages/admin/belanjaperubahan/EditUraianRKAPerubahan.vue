        ...
        <ModuleHeader>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Ubah Uraian Rencana Kegiatan dan Anggaran (RKA) OPD / Unit Kerja APBD Perubahan
                </v-alert>
            </template>
        </ModuleHeader>
        <v-container > 
            <v-row class="mb-4" no-gutters>
                <v-col cols="12">
                    <v-bottom-navigation color="purple lighten-1">                        
                        <v-btn :to="{path:'/belanjaperubahan/rka/uraian/'+datauraian.RKAID}"> 
                            <span>Keluar</span>
    ...
    methods: {
        ...
        updateuraian:async function ()
        {
            if (this.$refs.frmedituraian.validate())
            {
                ...
                await this.$ajax.post('/belanja/rkaperubahan/updatedetailuraian/'+this.formdata.RKARincID,
                    {
                        _method: 'PUT',
        ...
        closeedituraian()
        {
            this.$router.push('/belanjaperubahan/rka/realisasi/'+this.formdata.RKARincID);                                
        }
    },
    watch:{
