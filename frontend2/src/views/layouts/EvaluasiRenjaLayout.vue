<template>
    <div>
        ...
        <v-navigation-drawer v-model="drawer" width="300" dark :class="this.$store.getters['uifront/getTheme']('V-NAVIGATION-DRAWER-CSS-CLASS')" :temporary="temporaryleftsidebar" app>
			...
			<v-divider></v-divider>
            <v-list expand>
                <v-list-item :to="{path:'/evaluasirenja'}" v-if="CAN_ACCESS('EVALUASI-RENJA_BROWSE')" link class="yellow" color="green" >
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-home-floor-b</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>BOARD EVALUASI</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>                
                <v-divider />                
                <v-subheader>LAPORAN</v-subheader>
                <v-list-item link v-if="CAN_ACCESS('EVALUASI-RENJA-MURNI_BROWSE')" to="/evaluasirenja/murni">
                    <v-list-item-icon class="mr-2">
                ...
                <v-list-item link v-if="CAN_ACCESS('EVALUASI-RENJA-PERUBAHAN_BROWSE')" to="/evaluasirenja/perubahan">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-graph</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>
                            EVALUASI RENJA PERUBAHAN
                        </v-list-item-title>
                    </v-list-item-content>
                </v-list-item>                  
            </v-list>
