    ...
    private function print()  
    {
        ...
        foreach ($daftar_program as $data_program)
        {
            ...
            $daftar_kegiatan = \DB::table('trRKA')
                                    ->select(\DB::raw('"RKAID","kode_kegiatan","KgtNm","PaguDana2","lokasi_kegiatan2","SOrgNm"'))
            ...
            if(isset($daftar_kegiatan[0]))
            {
                ...
                $persen_bobot_program=Helper::formatPersen($totalpagueachprogram,$totalPaguUnit,2);
                ...
                $sheet->setCellValue("L$row",Helper::formatUang($data_realisasi_program[0]->realisasi2));  
                ...
                foreach ($daftar_kegiatan as $n)
                {
                    ...
                    $persen_bobot=Helper::formatPersen($nilai_pagu_proyek,$totalPaguUnit,2);
                    ...
                    $sheet->setCellValue("O$row",$n->lokasi_kegiatan2);  
