...
class FormBOPDPerubahanController extends Controller 
{
    ...
    public function printtoexcel (Request $request)
    {
        ...
        if (\DB::table('trRKA')->where('kode_organisasi',$opd->kode_organisasi)->where('EntryLvl',2)->where('TA',$tahun)->count()>0)
        {
            $data_report=[
            ...
            $report= new \App\Models\Report\FormBOPDPerubahanModel ($data_report);
