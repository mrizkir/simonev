...
class EvaluasiRKPDPerubahanController extends Controller 
{
     /**
    ...
    {             
        $this->hasPermissionTo('EVALUASI RKPD PERUBAHAN_BROWSE');
    ...
    public function printtoexcel (Request $request)
    {
        ...
        $report= new \App\Models\Report\EvaluasiRKPDPerubahanModel ($data_report);
