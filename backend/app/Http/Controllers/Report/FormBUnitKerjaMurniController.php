...
class FormBUnitKerjaMurniController extends Controller 
{
     /**
    ...
    public function printtoexcel (Request $request)
    {
        ...
        $unitkerja = SubOrganisasiModel::find($SOrgID);
        if (\DB::table('trRKA')->where('kode_suborganisasi',$unitkerja->kode_suborganisasi)->where('EntryLvl',1)->where('TA',$tahun)->count()>0)
        {
            $data_report=[
            ...
            $report= new \App\Models\Report\FormBUnitKerjaMurniModel ($data_report);
