    ...
    <div class="collapse dont-collapse-sm" id="displayOptions">
        <div class="d-block d-md-inline-block">
            ...
            <div class="form-group">
                {!!Form::select('bulan',Helper::getBulan(),date('n'),['id'=>'bulan','class'=>'form-control mr-1'])!!}
                {!!Form::select('ta',\App\Models\DMaster\TAModel::pluck('TACd','TACd'),2020,['id'=>'ta','class'=>'form-control'])!!}
            </div>
            {!! Form::close()!!}
        </div>
