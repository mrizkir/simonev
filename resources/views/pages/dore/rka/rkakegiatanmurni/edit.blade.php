            ...
            <div class="card-body">
                ...
                {!! Form::open(['action'=>'RKA\RKAKegiatanMurniController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {{Form::select('PrgID', $daftar_program, $data->PrgID, ['class'=>'form-control select'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{Form::label('RKPDID','RKPD',['class'=>'col-sm-2 col-form-label'])}}
                        <div class="col-sm-10">
                            {{Form::select('RKPDID', $daftar_rkpd, $data->RKPDID, ['class'=>'form-control select'])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {{Form::select('KgtID', $daftar_rkpd, $data->KgtID, ['class'=>'form-control select'])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {{Form::text('PaguDana1',$data->PaguDana1,['class'=>'form-control','placeholder'=>'Pagu Dana'])}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            {{Form::select('nip_pa', $daftar_pa, $data->nip_pa1, ['class'=>'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{Form::label('nip_kpa','Kuasa Pengguna Anggaran:',['class'=>'col-sm-2 col-form-label'])}}
                        <div class="col-sm-10">
                            {{Form::select('nip_kpa', $daftar_kpa, $data->nip_kpa1, ['class'=>'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{Form::label('nip_ppk','PPK:',['class'=>'col-sm-2 col-form-label'])}}
                        <div class="col-sm-10">
                            {{Form::select('nip_ppk', $daftar_ppk, $data->nip_ppk1, ['class'=>'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{Form::label('nip_pptk','PPTK:',['class'=>'col-sm-2 col-form-label'])}}
                        <div class="col-sm-10">
                            {{Form::select('nip_pptk', $daftar_pptk, $data->nip_pptk1, ['class'=>'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group row">
