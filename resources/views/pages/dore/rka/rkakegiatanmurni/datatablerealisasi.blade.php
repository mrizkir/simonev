    ...
    <table class="table" style="background:white">
        <thead class="thead-light">
            <tr>
                ...
                <th scope="col" width="110" class="text-right">REALISASI/SP2D</th>
                <th scope="col" width="110" class="text-right">RENCANA TARGET FISIK (%)</th>
                <th scope="col" width="80">SISA ANGGARAN</th>
