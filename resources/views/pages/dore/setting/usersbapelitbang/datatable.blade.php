                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group-append">
                                ...
                                @if ($item->isdeleted)  
                                <a class="btn btn-primary btn-xs mr-sm-2 default btnDelete" href="javascript:;" title="Hapus Data User" data-id="{{$item->id}}" class="btn btn-danger btn-xs default" data-url="{{route('usersbapelitbang.index')}}">
