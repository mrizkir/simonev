...
<div class="content">
    <div class="card mb-4">
        <div class="card-body">
            ...
            {!! Form::open(['action'=>'Setting\UsersBapelitbangController@store','method'=>'post','class'=>'form-horizontal','id'=>'frmdata','name'=>'frmdata'])!!}                              
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {{Form::select('theme', $daftar_theme, 'default', ['class'=>'form-control','id'=>'theme','placeholder' => 'Pick Theme...'])}}
                    </div>
                </div>
                <div class="form-group row">
