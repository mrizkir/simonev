...
<div class="content">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="separator mb-5"></div>
            {!! Form::open(['action'=>['DMaster\JenisPelaksanaanController@update',$data->JenisPelaksanaanID],'method'=>'put','class'=>'form-horizontal tooltip-label-bottom','id'=>'frmdata','name'=>'frmdata','novalidate'=>true])!!}                                                                              
                <div class="form-group row has-float-label">
                    {{Form::label('NamaJenis','Nama Jenis:',['class'=>'col-sm-2 col-form-label'])}}
                    <div class="col-sm-10">
                        {{Form::text('NamaJenis',$data['NamaJenis'],['class'=>'form-control','placeholder'=>'Nama Jenis'])}}
                    </div>
                </div>
                <div class="form-group row has-float-label">
