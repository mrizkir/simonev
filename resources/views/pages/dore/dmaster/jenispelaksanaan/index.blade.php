...
<li class="breadcrumb-item active" aria-current="page">JENIS PELAKSANAAN</li>
@endsection
...
<div class="row">
    <div class="col-12" id="divdatatable">
        @include('pages.dore.dmaster.jenispelaksanaan.datatable')
    </div>
</div>
@endsection
...
$(document).ready(function () {  
    $("#divdatatable").on("click",".btnDelete", function(){
        swal.fire ({
            title:'Hapus Data',
            text:'Apakah ingin menghapus data Jenis Pelaksanaan ini ?',
            type: 'warning',
                ...
                $.ajax({            
                    ...
                    success:function(result){ 
                        if (result.success==1){
                            ...
                            console.log("Gagal menghapus data Jenis Pelaksanaan dengan id "+id);
                        }                    
                    },
