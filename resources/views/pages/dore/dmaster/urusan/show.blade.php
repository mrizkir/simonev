                            ...
                            <div class="col-md-6">
                                <form>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>KODE URUSAN:</strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">
                                                {{$data->kelompokurusan->Kd_Urusan}}.{{$data->Kd_Bidang}}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>NAMA URUSAN:</strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->Nm_Bidang}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>NAMA KELOMPOK
                                                URUSAN:</strong></label>
                                        <div class="col-md-8">
