                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group-append">
                                    <a href="{{route('asnopd.show',['uuid'=>$item->RiwayatJabatanASNID])}}" class="btn btn-primary btn-xs mr-sm-2 default"  title="Detail Riwayat ASN">
                                        <i class="simple-icon-eye"></i>
                                    </a> 
                                    <a href="javascript:;" title="Hapus Data ASN" data-id="{{$item->RiwayatJabatanASNID}}" class="btn btn-danger btn-xs default btnDelete" data-url="{{route('asnopd.index')}}">
                            ...
                            <td colspan="6">                                
                                <p class="mb-3">
                                    <span class="badge badge-pill badge-outline-theme-2 mb-1">
                                        <strong>RiwayatJabatanASNID:</strong>{{$item->RiwayatJabatanASNID}}
                                    </span>
                                    <span class="badge badge-pill badge-outline-theme-2 mb-1">
