...
<div class="text-zero top-right-button-container">
    <div class="btn-group">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="{{route('transaksi.create')}}" title="Tambah TRANSAKSI">
...
<div class="row">
    <div class="col-12" id="divdatatable">
        @include('pages.dore.dmaster.transaksi.datatable')
    </div>
</div>
@endsection
                ...
                $.ajax({            
                    ...
                    success:function(result){ 
                        if (result.success==1){
                            ...
                            console.log("Gagal menghapus data transaksi dengan id "+id);
                        }                    
                    },
