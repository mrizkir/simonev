...
@endsection
@section('page_info')
@include('pages.dore.dmaster.objek.info')
@endsection
...
<div class="text-zero top-right-button-container">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="{!!route('objek.index')!!}">
...
<li class="breadcrumb-item">
    <a href="{!!route('objek.index')!!}">OBJEK</a>
</li>
                            ...
                            <div class="col-md-6">
                                <form>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>KODE RINCIAN: </strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->ObyID}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>KODE OBJEK: </strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->Kd_Rek_5}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>NAMA OBJEK: </strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->RObyNm}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
