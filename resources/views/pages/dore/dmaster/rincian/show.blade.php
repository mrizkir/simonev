...
@endsection
@section('page_info')
@include('pages.dore.dmaster.rincian.info')
@endsection
...
<div class="text-zero top-right-button-container">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="{!!route('rincian.index')!!}">
...
<li class="breadcrumb-item">
    <a href="{!!route('rincian.index')!!}">RINCIAN</a>
</li>
                            ...
                            <div class="col-md-6">
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->JnsID}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>KODE RINCIAN: </strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->Kd_Rek_4}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>NAMA RINCIAN: </strong></label>
                                        <div class="col-md-8">
                                            <p class="form-control-static">{{$data->ObyNm}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
