...
@endsection
@section('page_info')
@include('pages.dore.dmaster.program.info')
@endsection
                            ...
                            <div class="col-md-6">
                                <form>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>KODE PROGRAM: </strong></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label"><strong>NAMA PROGRAM: </strong></label>
                                        <div class="col-md-8">
