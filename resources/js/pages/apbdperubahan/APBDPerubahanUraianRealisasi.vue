                            ...
                            <div class="row">                                      
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <p class="form-control-static">{{datauraian.pagu_uraian2|formatUang}}</p>
                                        </div>                            
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <vue-autonumeric 
                                                    ...
                                                    class="form-control" 
                                                    v-bind:class="{'is-invalid': $v.form.realisasi2.$error, 'is-valid': $v.form.realisasi2.$dirty && !$v.form.realisasi2.$invalid}">
                                                </vue-autonumeric>
                                                <div class="text-danger" v-if="$v.form.realisasi2.$error">* Mohon untuk di isi atau nilai yang di isi telah melampau {{form.pagu_uraian|formatUang}}</div>
                                            </div>
                                            <div class="col-sm-5">
                                                <p class="form-control-static">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <vue-autonumeric 
                                                    ...
                                                    class="form-control" 
                                                    v-bind:class="{'is-invalid': $v.form.fisik2.$error, 'is-valid': $v.form.fisik2.$dirty && !$v.form.fisik2.$invalid}">
                                                </vue-autonumeric>
                                                <div class="text-danger" v-if="$v.form.fisik2.$error">* Mohon untuk di isi atau nilai yang di isi telah melampau 100%</div>
                                            </div>
                                            <div class="col-sm-5">
                                                <p class="form-control-static">
                            ...
                            <table class="table table-striped table-hover mb-2 table-condensed">
                                ...
                                <tbody>  
                                    <tr v-for="(item,index) in daftar_realisasi" v-bind:key="item.RKARealisasiRincID">
                                        ...
                                        <td class="text-right">{{item.target2|formatUang}}</td>
                                        <td class="text-right">{{item.realisasi2|formatUang}}</td>
                                        <td class="text-center">{{item.target_fisik2}}</td>
                                        <td class="text-center">{{item.fisik2}}</td>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!-- /.card-header -->
                    <div class="alert alert-danger alert-dismissible">
                        <router-link to="/apbdperubahan/uraian" class="close">
                            <i class="fas fa-times"></i>
                        </router-link>
                        <h5><i class="icon fas fa-ban"></i> Alert!</h5>
...
export default {
    ...
    methods: 
    {
        populateData(page=1)
        {           
            axios.get('/api/v1/apbdperubahan/uraian/realisasi/'+this.datauraian.RKARincID,{
                headers:{
            ...
            .then(response => {                                        
                ...
                this.form.pagu_uraian=parseFloat(this.datauraian.pagu_uraian2);
        ...
        { 
            ...
            {      
                case 'create' :                    
                    if ((parseFloat(this.totalRealisasiAll) < parseFloat(this.datauraian.pagu_uraian2)) || (parseFloat(this.totalFisikAll)< 100))
                    {                    
                        this.pid = pid;
                        axios.get('/api/v1/apbdperubahan/create4/'+this.datauraian.RKARincID,{
                            headers:{
                                'Authorization': window.laravel.api_token,
                            }
                        })
                ...
                case 'edit' :
                    ...
                    this.form.bulan=item.bulan2;
                    
                    this.form.anggarankas=item.target2;
                    this.form.targetfisik=item.target_fisik2;

                    this.form.totalrealisasi=this.form.totalrealisasi-item.realisasi2;
                    this.form.realisasi2=item.realisasi2;

                    this.form.totalfisik=this.form.totalfisik-item.fisik2;
                    this.form.fisik2=item.fisik2;
                ...
                case 'destroy':
                    ...
                    this.$swal({
                        ...
                        {
                            axios.post('/api/v1/apbdperubahan/'+item.RKARealisasiRincID,{
                                '_method':'DELETE',
                                'pid':'datarealisasi'
                            },{
                                headers:{
		...
		{	
            ...
            {                 
                axios.post('/api/v1/apbdperubahan/store4',{                   
                    'RKARincID':this.datauraian.RKARincID,
                    'RKAID':this.detailkegiatan.RKAID,
                    'bulan2':this.form.bulan,                   
                    'target2':this.form.anggarankas,                   
                    'realisasi2':this.form.realisasi2,                   
                    'target_fisik2':this.form.targetfisik,                   
                    'fisik2':this.form.fisik2,                   
        ...
        updateData()
        {
            ...
            if(this.$v.$invalid == false)
            {                 
                axios.post('/api/v1/apbdperubahan/update4/'+this.form.RKARealisasiRincID,{                   
                    'realisasi2':this.form.realisasi2,                   
                    'fisik2':this.form.fisik2,                   
                    'Descr':this.form.Descr,                   
                },{
