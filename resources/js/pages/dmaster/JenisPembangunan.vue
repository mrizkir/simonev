            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">JENIS PEMBANGUNAN</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
				...
				<div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-plus"></i> Tambah Jenis Pembangunan
                            </h3>
            ...
            <div class="row" v-if="pid=='edit'">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-plus"></i> Ubah Jenis Pembangunan
                            </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" v-on:click.prevent="proc('default',null)">
                                    <i class="fas fa-times"></i>
            ...
            <div class="row" v-if="pid=='show'">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-eye"></i> DETAIL JENIS PEMBANGUNAN</h3>
                            <div class="card-tools">                                 
                                <button type="button" class="btn btn-tool" v-on:click.prevent="proc('create',null)">
                                    <i class="fas fa-plus"></i>
                                </button>                                
                                <button type="button" class="btn btn-tool" v-on:click.prevent="proc('edit',jenispembangunan.detail)">
                                    <i class="fas fa-edit"></i>
                                </button>                                
                                <button type="button" class="btn btn-tool text-danger" v-on:click.prevent="proc('destroy',jenispembangunan.detail)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <p class="form-control-static">{{jenispembangunan.detail.JenisPembangunanID}}</p>
                                            </div>                            
                                        </div>                                          
                                        <div class="form-group row">
                                            <label class="col-md-4 control-label"><strong>NAMA JENIS: </strong></label>
                                            <div class="col-md-8">
                                                <p class="form-control-static">{{jenispembangunan.detail.NamaJenis}}</p>
                                            </div>                            
                                        </div>
                                    </div>      
                                </div>
                                <div class="col-md-6">
                                    <div class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <p class="form-control-static">{{jenispembangunan.detail.Descr}}</p>
                                            </div>                            
                                        </div> 
                                        <div class="form-group row">
                                            <label class="col-md-4 control-label"><strong>DI BUAT / UBAH: </strong></label>
                                            <div class="col-md-8">
                                                <p class="form-control-static">{{jenispembangunan.detail.created_at|formatTanggal}} / {{jenispembangunan.detail.updated_at|formatTanggal}}</p>
                                            </div>                            
                                        </div>                                        
                                    </div>      
                                </div>
            ...
            <div class="row" v-if="pid=='default'">               
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0" v-if="daftar_jenispembangunan.data.length">
                            <table class="table table-striped table-hover mb-2">
                                ...
                                <tbody>  
                                    <tr v-for="(item,index) in daftar_jenispembangunan.data" v-bind:key="item.JenisPembangunanID">
                                        <td>{{daftar_jenispembangunan.from+index}}</td>
                        ...
                        <div class="card-footer" v-if="daftar_jenispembangunan.data.length">                            
                            <pagination :data="daftar_jenispembangunan" @pagination-change-page="populateData" align="center" :show-disabled="true" :limit="8">
...
export default {
    ...
    {	
        populateData(page=1)
        {           
            axios.get('/api/v1/master/jenispembangunan?page='+page,{
                headers:{
                    'Authorization': window.laravel.api_token,
                }
            })
            .then(response => {                                        
                this.jenispembangunan=response.data; 
                this.daftar_jenispembangunan = this.jenispembangunan.daftar_jenispembangunan;                           
            })
            .catch(response => {
        ...
        {           
            ...
            switch (pid)
            {
                ...
                case 'show' :
                    this.pid = pid;
                    this.jenispembangunan.detail = item;
                break;
                case 'edit' :
                    this.pid = pid;
                    this.form.JenisPembangunanID=item.JenisPembangunanID;                   
                ...
                case 'destroy':
                    ...
                    this.$swal({
                        ...
                        {
                            axios.post('/api/v1/master/jenispembangunan/'+item.JenisPembangunanID,{
                                '_method':'DELETE',
                            },{
                                headers:{
                                    'Authorization': window.laravel.api_token,
		...
		{	
            ...
            { 
				axios.post('/api/v1/master/jenispembangunan',{
                ...
                .then(response => {                          
                    this.$swal({
                        ...
                        text: "Menyimpan Data Jenis Pembangunan berhasil dilakukan",
        ...
        updateData() 
		{
            ...
            if(this.$v.$invalid == false)
            { 
                axios.post('/api/v1/master/jenispembangunan/'+this.form.JenisPembangunanID,{
                    '_method':'PUT',
                    'NamaJenis':this.form.NamaJenis,
                    'Descr':this.form.Descr,
                },{
                ...
                .then(response => {                          
                    this.$swal({
                        title: '<i class="fas fa-spin fa-spinner"></i>',
                        text: "Mengubah Data Jenis Pembangunan berhasil dilakukan",
                        showCancelButton: false,
                        showConfirmButton: false,
                        showCloseButton: false,
                        allowOutsideClick: false,
